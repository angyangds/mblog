...
<div id="right">
    ...
    <div class="div_head">
            <span>
                <span style="float: left;">当前位置是：后台管理-》管理员列表</span>
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="<?php echo U('Manager/add');?>">【添加管理员】</a>
                </span>
            </span>
</div>
<div class="div_search" style="float:left;clear:both; font-size: medium;margin: 20px;">
    <span>
        <form action="<?php echo U('Manager/search');?>">
            <label id="search_title" for="search_content">管理员</label>
...
<div style="font-size: 13px; margin: 10px 5px;">
    <table class="table_a" border="1" width="100%">
        ...
        <?php if(is_array($managers)): $i = 0; $__LIST__ = $managers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$manager): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($manager["user"]); ?></td>
                <td><a href="<?php echo ($manager["update_url"]); ?>">修改</a> </td>
                <td><a href="<?php echo ($manager["delete_url"]); ?>">删除</a> </td>
