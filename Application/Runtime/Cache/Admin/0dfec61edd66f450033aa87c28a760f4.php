                                ...
                                <div class="user_main_box">
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            <input class="TxtUserNameCssClass" id="name" maxlength="20" name="name"> </li></ul>
                                    <ul>
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="/index.php/Admin/Login/generateCode"  alt="" width="100px" height="40"
                                                 onclick="this.src='/index.php/Admin/Login/generateCode/' + Math.random()"
