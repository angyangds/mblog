...
<html>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="<?php echo U('Category/index');?>">【返回】</a>
                </span>
            </span>
        </div>
        <div></div>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="<?php echo U('Category/add');?>" method="post" enctype="multipart/form-data">
            <table border="1" width="100%" class="table_a">
                <tr>
                    <td>栏目名称</td>
                    <td><input type="text" name="name"  placeholder="栏目名称" onkeyup="isExisted(this)"/></td>
                    <td><label id="username-error" class="error" for="name" style="color: red"></label></td>
                </tr>
                <tr>
                    <td>栏目描述</td>
                    <td><input type="text" name="description" placeholder="栏目描述"/></td>
                </tr>
                <tr>
